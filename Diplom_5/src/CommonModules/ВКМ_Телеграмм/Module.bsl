...
Процедура ВКМ_ТГУведомление() Экспорт
	...
	|	ВКМ_УведомленияТГБоту.ВКМ_ТекстСоббщения КАК ТекстСообщения
	|ИЗ
	...
	Пока Выборка.Следующий() Цикл
		...
		Иначе
			...
			ЗаписьЖурналаРегистрации("HTTPСервисы.Ошибка", УровеньЖурналаРегистрации.Ошибка, , ,ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИиформацияОбОшибке));
		КонецЕсли;
